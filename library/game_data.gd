...
const CLEAN_PHONE_CALL: int = int(MAX_LOAD_PER_CART * 0.8)
...
const RAW_FILE_REDUCE_COOLDOWN_PUSH_SERVANT: int = RAW_FILE_ADD_COOLDOWN
const RAW_FILE_REDUCE_COOLDOWN_UNLOAD_SERVANT: int = RAW_FILE_ADD_COOLDOWN * 5

# Base cooldown & active effects are multiplied by a factor.
const RAW_FILE_COOLDOWN_MOD: int = 10
...
const RAW_FILE_ADD_COOLDOWN: int = BASE_PAGE * 2 * RAW_FILE_COOLDOWN_MOD
const SERVANT_ADD_COOLDOWN: int = BASE_PAGE * 3 * RAW_FILE_COOLDOWN_MOD
